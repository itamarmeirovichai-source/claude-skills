...
Actively looks for what's wrong, what's missing, what will fail. Assumes the idea has a fatal flaw and tries to find it.
...
Looks for upside everyone else is missing. What could be bigger? What adjacent opportunity is hiding? The Expansionist doesn't care about risk.


### 4. The Outsider

Has zero context about you, your field, or your history. Responds purely to what's in front of them. Catches the curse of knowledge.


### 5. The Executor

Only cares about one thing: can this actually be done, and what's the fastest path to doing it? Ignores theory and strategy.


**Why these five:** They create three natural tensions. Contrarian vs Expansionist (downside vs upside). First Principles vs Executor (rethink everything vs just do it). The Outsider sits in the middle.
...
Respond from your perspective. Be direct and specific. Don't hedge. Lean fully into your assigned angle.
...
Collect all 5 advisor responses. Anonymize them as Response A through E. Spawn 5 new sub-agents to answer:
...
The chairman gets everything: the original question, all 5 advisor responses (de-anonymized), and all 5 peer reviews.
...
1. **Where the council agrees** - points multiple advisors converged on independently.
2. **Where the council clashes** - genuine disagreements presented without smoothing.
3. **Blind spots the council caught** - things that only emerged through peer review.
4. **The recommendation** - a clear, actionable recommendation. Not "it depends." A real answer.
...
Present the full verdict directly in chat using markdown. Do NOT generate an HTML report or any files. Format:
...
- **Always anonymize for peer review.** Reviewers should evaluate on merit, not defer to certain styles.
- **The chairman can disagree with the majority.** If the reasoning of the 1 dissenter is strongest, side with the dissenter.
