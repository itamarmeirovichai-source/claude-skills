...
# נקודות העיגון. הן נגזרות ממה ש-replay.py מדפיס בפועל ולא מוזנות
# כסקלר זכור: הריצה מחזירה +0.101R עם רווח [-0.197, +0.398] על 28
# ימי-עסקה, ומחצית-הרווח הזו חלקי t(27) היא שגיאת התקן. גרסה קודמת
# קיבעה כאן SE=0.207, שממנו נובע רווח [-0.324, +0.526] — לא הרווח
# שהודפס. זה הכפיל כל שורה בטבלה. מי שמעדכן מדידה מעדכן את שתי
# השורות למטה מתוך פלט הריצה, ולא את שגיאת התקן ישירות.
MEAN_MEASURED = 0.101
