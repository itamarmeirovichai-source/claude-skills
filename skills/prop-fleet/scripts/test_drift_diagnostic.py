...
def test_the_real_data_that_fell_through():
    """הנתונים האמיתיים של איתמר: פיגור נעול על ~15 יום.

    הסף הישן (0.5) פסל את זה בשוליים של 0.4% — פיזור 7.97 מול סף 7.93 —
    והתשובה נפלה ל"בלי תבנית ברורה" למרות שהפילוח החודשי הראה 15.12,
    15.74, 15.86. מספר שכמעט לא זז אינו חוסר תבנית.
    """
    assert classify(0.001, 74.0, 0.233, 15.86, 21.94 - 13.97) == CACHE
